...
import { ArrowRight, Bus, Search, ShieldCheck, ShoppingBag, Box, CircleCheck } from "lucide-react";
...
export const Route = createFileRoute("/")({
  head: () => ({ meta: [{ title: "Campus Crate — Your Campus, Connected" }, { name: "description", content: "Find lost items, student deals, and campus shuttles in one community." }, { property: "og:title", content: "Campus Crate — Your Campus, Connected" }, { property: "og:description", content: "Find lost items, student deals, and campus shuttles in one community." }, { property: "og:type", content: "website" }, { name: "twitter:card", content: "summary_large_image" }] }),
  component: Index,
});
...
const features = [
  ...
  { title: "Shuttle Service", copy: "Find active campus shuttles and request a pickup on your route.", action: "View Shuttle Service", to: "/shuttle", icon: Bus, tone: "feature-green" },
];
